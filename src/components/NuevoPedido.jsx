...
const NuevoPedido = () => {
  ...
  return (
    <div className="container">
      ...
      <p>Gorditas</p>
        ...
        <div className="content__burgers">
            {products.map((product) => (
              <div key={product.id} className="burger" style={{ border: "thin solid cyan", color: "yellow"}} 
        ...
        <div className="content__burgers">
            {products2.map((product) => (
              <div key={product.id} className="burger" style={{border: "thin solid lavender", color: "pink"}} 
               onClick={() =>
                dispatch({
                  type: types.productAddToCart,
                  payload: product,
        ...
        <div className="content__burgers">
            {producto3.map((product) => (
              <div key={product.id} className="burger" style={{ border: "thin solid cyan", color:"whitesmoke" }}
              onClick={() =>
                dispatch({
                  type: types.productAddToCart,
                  payload: product,
      ...
      <article className="container_carrito">
        <p>Pedido</p>
        {cart.map((product) => (
          
          <div
            key={product.id}
            style={{ border: "thin solid lime", background:"aquamarine" }}
          >
            
            <div className="content-carrito">
            {product.title}
            <h5>${product.price}.00</h5> x {product.quantity} = $
